...
function menu(id){
  if(document.getElementById("divek"+id)==null){
    document.getElementById("d"+id).innerHTML+= '<div id="divek'+ id +'"><button id="g'+ id +'" onclick="usun('+ id +')">✖</button> <button id="g'+ id +'" onclick="prawo('+ id +')">↺</button> <button id="g'+ id +'" onclick="duzy('+ id +')">+</button> <button id="g'+ id +'" onclick="maly('+ id +')">-</button></div>';
  }
